...
const socialLinks = [
    { href: 'https://discord.gg/pjA3ag9H', icon: DiscordIcon, label: 'Join Discord' },
    { href: 'https://x.com/relay_mcp', icon: XIcon, label: 'Follow on X' },
    { href: 'https://github.com/Emeenent14/relay', icon: GitHubIcon, label: 'View on GitHub' },
];
